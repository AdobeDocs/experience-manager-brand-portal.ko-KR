...
description: 2022.02.0에 대한 새로운 기능 및 개선 사항은 무엇입니까?
...
Brand Portal 2021.02.0은 AEM Assets as a Cloud Service에서 Brand Portal 활성화 워크플로우를 제공하는 개선 사항 릴리스이며, AEM Assets에서 자산 소싱 기능을 간편하게 하고, 자산 다운로드 경험의 개선 사항을 포함하며, 중요한 수정 사항을 포함합니다. 또한 관리자는 임차인 수준에서 폴더, 컬렉션 및 자산의 벌크 다운로드의 기본 다운로드 동작을 구성할 수 있습니다. Brand Portal **[!UICONTROL 사용량 보고서]** 활성 Brand Portal 사용자를 반영하도록 도 수정되었습니다.
...
1. 목록에서 환경(하나씩)을 선택합니다. Brand Portal과 연관된 환경이 발견되면 **[!UICONTROL Brand Portal 활성화]** 활성화 워크플로우를 시작하는 단추.
1. Brand Portal 테넌트가 활성화되면 상태가 활성화됨으로 변경됩니다.

![상태 보기](assets/create-environment5.png)

자세한 내용은 [AEM Assets에서 Brand Portal 활성화 as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/brand-portal/configure-aem-assets-with-brand-portal.html).
...
자세한 내용은 [Brand Portal의 자산 소싱](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/asset-sourcing-in-brand-portal/brand-portal-asset-sourcing.html?lang=ko-KR).

### 에셋 다운로드 {#asset-download-setting}

기존 **[!UICONTROL 다운로드 설정]**&#x200B;로 지정하는 Brand Portal 관리자는 이제 **[!UICONTROL 자산 다운로드]** 설정 이 설정을 사용하면 관리자는 임차인 수준에서 폴더, 컬렉션 및 자산(20개 이상의 자산)의 벌크 다운로드의 기본 다운로드 동작을 제어할 수 있습니다.

<!--
Earlier, all the asset renditions were directly downloaded in a zip folder in case of folder, collection, and bulk download of assets. As the **[!UICONTROL Download]** dialog is skipped for folders or collections, there was no mechanism to control the downloading behaviour of the assets. Due to this, the users were finding it difficut to search for a particular asset rendition from a folder containing huge bunch of downloaded renditions. 
-->

이전에는 모든 자산 표현물이 zip 폴더에서 직접 다운로드되었습니다. 다음 **[!UICONTROL 다운로드]** 폴더 및 컬렉션에 대한 대화 상자를 건너뛰었으며, 자산의 다운로드 동작을 제어하는 방법이 없으므로 여러 다운로드에서 특정 렌디션을 검색하기가 어렵습니다.

**[!UICONTROL 자산 다운로드]** 이제 설정을 통해 폴더, 컬렉션 또는 자산의 벌크 다운로드를 다운로드하는 동안 각 자산에 대해 별도의 폴더를 만들 수 있는 옵션을 제공합니다.

만약 **[!UICONTROL 자산 다운로드]** 설정이 비활성화되면, 폴더 또는 컬렉션은 공유 링크를 사용하여 자산을 다운로드하는 것을 제외하고 동일한 폴더에 있는 모든 자산 표현물이 들어 있는 zip 폴더에서 다운로드됩니다.


관리자로 Brand Portal 테넌트에 로그인하고 **[!UICONTROL 도구]** > **[!UICONTROL 다운로드]**. 관리자는 **[!UICONTROL 자산 다운로드]** 자산의 폴더, 컬렉션 및 벌크 다운로드를 다운로드하는 동안 각 자산에 대해 별도의 폴더를 만들도록 설정합니다.

![](assets/download-settings-new.png)

자세한 내용은 [Brand Portal에서 자산 다운로드](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/download/brand-portal-download-assets.html).
<!--
...
Brand Portal **[!UICONTROL 사용량 보고서]** 활성 Brand Portal 사용자만 반영하도록 가 수정되었습니다. Admin Console에서 제품 프로필에 할당되지 않은 Brand Portal 사용자는 비활성 사용자로 간주되며 **[!UICONTROL 사용량 보고서]**.
...
Brand Portal 2020.10.0은 자산 다운로드 환경을 단순화하는 데 중점을 둔 개선 릴리스이며 중요한 수정 사항이 포함되어 있습니다. 개선 사항에는 자산 다운로드를 위한 새롭고 향상된 워크플로우, 렌디션을 제외하는 추가 옵션, 다음에서 직접 다운로드 등이 포함됩니다 **[!UICONTROL 표현물]** 패널, 특정 사용자 그룹에 대한 액세스 및 다운로드 권한을 허용하는 구성, 모든 Brand Portal 페이지에서 파일, 컬렉션 및 공유 링크에 대한 쉬운 탐색. 최신 항목 보기 [Brand Portal 릴리스 노트](brand-portal-release-notes.md).
...
다운로드 워크플로우는 독립형 자산, 여러 자산, 자산이 들어 있는 폴더, 라이선스가 있는 또는 라이선스가 없는 자산, 공유 링크를 사용하여 자산 다운로드에 대해 일정하게 유지됩니다. 자세한 내용은 [Brand Portal에서 자산을 다운로드하는 단계](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/download/brand-portal-download-assets.html).

![다운로드 대화 상자](assets/download-dialog-box.png)

### 빠른 탐색  {#quick-navigation}

이전에는 **[!UICONTROL 파일]**, **[!UICONTROL 컬렉션]**, 및 **[!UICONTROL 공유 링크]** 사용자가 다른 보기로 전환하려고 할 때마다 숨겨지고 여러 번 클릭이 필요합니다.

Brand Portal 2020.10.0에서 사용자는 **[!UICONTROL 파일]**, **[!UICONTROL 컬렉션]**, 및 **[!UICONTROL 공유 링크]** 빠른 탐색 링크를 사용하여 한 번의 클릭으로 모든 Brand Portal 페이지에서 페이지를 볼 수 있습니다.

![collection-navigation](assets/collection-navigation.png)

### 향상된 표현물 패널 {#rendition-panel}

이전에는 사용자가 **[!UICONTROL 표현물]** 패널입니다. **[!UICONTROL 사용자 정의 표현물]** 또는 **[!UICONTROL 시스템 표현물]** 이 활성화되었을 때 **[!UICONTROL 다운로드]** 구성. 또한 필요하지 않은 특정 사용자 지정 또는 동적 표현물을 제외하는 필터가 없으므로 사용자는 모든 자산 표현물을 다운로드해야 했습니다.
...
기존 **[!UICONTROL 다운로드]** 구성, Brand Portal 관리자는 자산 세부 사항 페이지에서 원본 자산 및 해당 표현물을 보고 다운로드할 다양한 사용자 그룹에 대한 설정을 구성할 수도 있습니다.

관리자로 Brand Portal 테넌트에 로그인하고 **[!UICONTROL 도구]** > **[!UICONTROL 사용자]**.

에서 **[!UICONTROL 사용자 역할]** 페이지로 이동하여 **[!UICONTROL 그룹]** 탭을 클릭하여 사용자 그룹의 보기 및 (또는) 다운로드 설정을 구성합니다.

이전에는 그룹 사용자가 원래 자산을 다운로드하지 못하도록 제한하는 데에만 설정을 사용할 수 있었습니다.

다음 **[!UICONTROL 그룹]** 탭에서 다음을 수행합니다. **[!UICONTROL 사용자 역할]** 관리자는 페이지에서 보기 및 다운로드 설정을 구성할 수 있습니다.

* 둘 다 **[!UICONTROL 원본 다운로드]** 및 **[!UICONTROL 표현물 다운로드]** 설정이 켜져 있으면 선택한 그룹의 사용자가 원래 자산과 해당 표현물을 보고 다운로드할 수 있습니다.
* 두 설정이 모두 꺼져 있으면 원래 자산만 볼 수 있습니다. 자산 표현물은 자산 세부 사항 페이지의 사용자에게 표시되지 않습니다.
* 다음의 경우에만 **[!UICONTROL 원본 다운로드]** 이 설정이 켜져 있으면 사용자는 자산 세부 사항 페이지에서 원래 자산만 보고 다운로드할 수 있습니다.
* 다음의 경우에만 **[!UICONTROL 표현물 다운로드]** 이 설정이 켜져 있으면 사용자가 원래 자산을 볼 수 있지만 다운로드할 수 없습니다. 그러나 사용자는 자산 표현물을 보고 다운로드할 수 있습니다.

자세한 내용은 [자산 다운로드 구성](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/download/brand-portal-download-assets.html#configure-download-permissions).
...
Brand Portal 6.4.7 릴리스는 문서 뷰어를 가져오고, 자산 다운로드 환경을 개선하며, 중요한 수정 사항을 포함합니다. 최신 항목 보기 [Brand Portal 릴리스 노트](brand-portal-release-notes.md).
...
Brand Portal 6.4.7에서 Brand Portal 관리자는 자산을 구성할 수 있습니다  **[!UICONTROL 다운로드]** 설정. 사용 가능한 구성은 다음과 같습니다.
...
* 둘 다 **[!UICONTROL 사용자 지정 표현물]** 및 **[!UICONTROL 시스템 표현물]** 구성이 꺼져 있으면, Brand Portal 사용자의 다운로드 경험을 간소화하는 추가 대화 상자 없이 자산의 원래 표현물이 다운로드됩니다.

* 다음 중 **[!UICONTROL 사용자 정의 표현물]** 또는 **[!UICONTROL 시스템 표현물]** 이 활성화되어 있으면, **[!UICONTROL 다운로드]** 대화 상자가 나타나고 자산 표현물과 함께 원본 자산이 다운로드됩니다. 활성화  **[!UICONTROL 빠른 다운로드]** 구성은 다운로드 프로세스를 가속화합니다.
...
자세한 내용은 [Brand Portal FAQ](brand-portal-faqs.md).
...
그런 다음 AEM 사용자는 기여 폴더에 추가해야 하는 자산 유형에 대한 요약을 업로드하고 기준 자산을 업로드하여 요구 사항을 정의합니다 **공유** 폴더를 삭제하여 Brand Portal 사용자에게 필요한 참조 정보가 있는지 확인하십시오. 그런 다음 관리자는 새로 만든 기여도 폴더를 게시하기 전에 활성 Brand Portal 사용자에게 기여도 폴더에 대한 액세스 권한을 부여할 수 있습니다 **기여도** 폴더를 Brand Portal에 추가합니다.


사용자가 다음에 콘텐츠를 추가했으면 **신규** 폴더, 기여도 폴더를 다시 AEM 작성자 환경에 게시할 수 있습니다. 가져오기를 완료하고 AEM Assets 내에 새로 게시된 콘텐츠를 반영하는 데 몇 분이 걸릴 수 있습니다.
...
적절한 권한이 있는 Brand Portal 사용자는 자산 요구 사항을 다운로드하여 기여의 필요성을 이해하고 여러 자산이 들어 있는 여러 자산 또는 폴더를 기여도 폴더에 업로드할 수 있습니다. 그러나 Brand Portal 사용자는 Analytics Mobile Services에서 자산을 **신규** 하위 폴더. 다음 **공유** 폴더는 요구 사항 및 기준 요소 자산을 분배하기 위한 것입니다.
...
업로드가 완료되면 **신규** 그런 다음 Brand Portal 사용자는 기여도 폴더를 다시 AEM에 게시할 수 있습니다. AEM Assets에서 게시된 콘텐츠/자산을 가져오고 반영하는 데 몇 분이 걸릴 수 있습니다. 자세한 내용은 [AEM Assets에 기여도 폴더 게시](brand-portal-publish-contribution-folder-to-aem-assets.md).
...
Brand Portal 6.4.4 릴리스는 텍스트 검색 향상 및 상위 고객 요청 사항에 중점을 둡니다. 최신 항목 보기 [Brand Portal 릴리스 노트](brand-portal-release-notes.md).

### 검색 개선 사항

Brand Portal 6.4.4 이상에서 필터링 창에서 속성 조건부에서 부분 텍스트 검색을 지원합니다. 부분 텍스트 검색을 허용하려면 다음을 활성화해야 합니다 **부분 검색** 검색 양식에서 속성 조건자로 표시합니다.
...
**사용 사례**
부분 구문 검색은 검색한 구문에서 발생하는 단어의 정확한 조합을 잘 모르는 경우 유용합니다.

예를 들어 Brand Portal의 검색 양식에서 자산 제목에서 부분 검색에 속성 설명을 사용한 다음 용어를 지정합니다 **캠프** 제목 구문에 camp 라는 단어가 포함된 모든 자산을 반환합니다.
...
예를 들어 **등산하기** 문자로 시작하는 단어가 있는 모든 자산을 반환합니다 **등벽** 제목 구문에서 Brand Portal의 검색 양식이 자산 제목에서 부분 검색에 속성 설명을 사용하는 경우

![](assets/wildcard-prop.png)

마찬가지로, 다음을 지정합니다.

* ***등반** 문자로 끝나는 단어가 포함된 모든 자산을 반환합니다 **등벽** 제목 구문에

* ***등반*** 문자를 포함하는 단어가 있는 모든 자산을 반환합니다 **등벽** 제목 구문에

>[!NOTE]
>
>선택 시 **부분 검색** 확인란, **대/소문자 무시** 기본적으로 선택되어 있습니다.
...
이제 관리자는 로그인 시 관리자가 아닌 사용자(편집기, 뷰어 및 게스트 사용자)에게 폴더가 표시되는 방식을 구성할 수 있습니다. [폴더 계층 활성화](../using/brand-portal-general-configuration.md) 구성에 추가됨 **일반 설정**( 관리 도구 패널) 아래에 그룹화됩니다. 구성이 다음과 같은 경우:

* **활성화됨**&#x200B;를 입력하면 관리자가 아닌 사용자가 루트 폴더에서 시작하는 폴더 트리를 볼 수 있습니다. 따라서 관리자와 유사한 탐색 경험을 제공할 수 있습니다.
* **비활성화됨**&#x200B;공유 폴더만 랜딩 페이지에 표시됩니다.

![](assets/enable-folder-hierarchy.png)

다음 [폴더 계층 활성화](../using/brand-portal-general-configuration.md) 기능(활성화된 경우)을 사용하면 서로 다른 계층 간에 공유되는 동일한 이름의 폴더를 구분할 수 있습니다. 로그인 시 이제 관리자가 아닌 사용자에게 공유 폴더의 가상 상위(및 상위) 폴더가 표시됩니다.
...
**경로 브라우저** 조건부는 특정 디렉터리에서 자산을 검색할 수 있도록 검색 양식에 도입됩니다. 경로 브라우저에 대한 검색 조건자의 기본 검색 경로는 다음과 같습니다 `/content/dam/mac/<tenant-id>/`기본 검색 양식을 편집하여 구성할 수 있습니다.
...
* 관리자가 아닌 사용자는 경로 브라우저 를 사용하여 공유된 폴더만 탐색(그리고 상위 폴더로 다시 이동)할 수 있습니다.
   ...
   예, `/content/dam/mac/<tenant-id>/folderA/folderB/folderC` 는 관리자가 아닌 사용자와 공유됩니다. 사용자는 경로 브라우저를 사용하여 폴더C 내에서 자산을 검색할 수 있습니다. 이 사용자는 folderB 및 folderA로 이동할 수도 있습니다(사용자와 공유되는 folderC의 상위 멤버이므로).
...
특정 테넌트 계정에서 Dynamic Media 표현물을 미리 보고 다운로드할 수 있도록 하려면 관리자는 다음을 지정해야 합니다 **Dynamic Media 구성** (비디오 서비스 URL(DM-게이트웨이 URL) 및 다이내믹 비디오를 가져오기 위한 등록 ID)은에서 **비디오** 관리 도구 패널에서 구성
...
의 자산(및 폴더) 게시 워크플로우 [AEM (6.4.2.0)](https://experienceleague.adobe.com/docs/experience-manager-64/release-notes/sp-release-notes.html) Brand Portal에 대한 작성자 인스턴스는 이후 날짜, 시간 동안 예약할 수 있습니다.
...
예를 들어 기존 도메인이 있는 조직 **geometrixx.brand-portal.adobe.com** 다음을 얻을 수 있습니다. **geometrixinc.brand-portal.adobe.com** 요청 시 생성됨.

그러나 AEM 작성자 인스턴스는 [구성](https://experienceleague.adobe.com/docs/experience-manager-65/assets/brandportal/configure-aem-assets-with-brand-portal.html) 임차인 id URL로만 사용하고, 임차인 별칭(대체) URL로는 사용하지 마십시오.
...
Brand Portal 사용자는 IBM Aspera Connect 기반의 빠른 다운로드를 적용하여 최대 25배 더 빠르게 속도를 낼 수 있으며 전 세계 위치에 상관없이 원활한 다운로드 경험을 제공할 수 있습니다. Brand Portal 또는 공유 링크에서 자산을 더 빨리 다운로드하려면 사용자가 선택해야 합니다 **다운로드 가속 활성화** 조직에서 다운로드 가속화를 사용할 수 있는 경우 다운로드 대화 상자의 옵션입니다.

![](assets/donload-assets-dialog-2.png)

조직에 대해 IBM Aspera 기반 가속 다운로드를 활성화하려면 관리자가 **다운로드 가속 활성화** 옵션(기본적으로 비활성화됨)의 [일반 설정](brand-portal-general-configuration.md#allow-download-acceleration) 를 클릭합니다. Brand Portal 및 공유 링크에서 자산 파일을 더 빨리 다운로드하기 위한 사전 요구 사항 및 문제 해결 단계에 대해 자세히 알아보려면 [Brand Portal에서 다운로드를 가속화하기 위한 안내서](../using/accelerated-download.md#main-pars-header).

### 사용자 로그인 보고서

사용자 로그인을 추적하는 새 보고서가 도입되었습니다. 다음 **사용자 로그인** 보고서는 조직이 Brand Portal의 위임된 관리자 및 사용자를 감사하고 확인할 수 있도록 하는 데 도움이 될 수 있습니다.
...
Brand Portal 6.4.2 이상에서 이전 OAuth(`https://legacy-oauth.cloud.adobe.io/`) 인터페이스를 사용하여 JWT 애플리케이션을 만들 수 있습니다. 이 경우 Brand Portal과의 AEM Assets 통합을 허용하도록 oAuth 통합을 구성할 수 있습니다. 이전에는 OAuth 통합 구성을 위한 UI가 `https://marketing.adobe.com/developer/`. Brand Portal에 자산 및 컬렉션을 게시하기 위해 AEM Assets과 Brand Portal을 통합하는 방법에 대한 자세한 내용은 다음을 참조하십시오 [Brand Portal과 AEM Assets 통합 구성](https://experienceleague.adobe.com/docs/experience-manager-64/assets/brandportal/configure-aem-assets-with-brand-portal.html).
...
* 예를 들어 새로운 키보드 단축키가 도입되었습니다 _(p)_ 속성 페이지로 이동하는 경우 _마._ 편집용 및 _(ctrl+c)_ 복사 작업에 사용됩니다.
...
* 열 보기가 **더 자세히** 자산 스냅샷 아래에서 자산의 세부 사항 페이지로 이동할 수 있습니다.

![](assets/columnmoredetail.png)

* 이제 목록 보기에는 로케일, 자산 유형, 차원, 크기, 등급 및 게시 정보 외에 기본적으로 첫 번째 열에 자산의 파일 이름이 표시됩니다. 새로 만들기 **설정 보기** 목록 보기에 표시할 세부 사항의 양을 구성하는 데 사용할 수 있습니다.
...
**도입된 링크 공유 보고서**
공유 링크에 대한 정보를 제공하는 새 보고서가 도입되었습니다. 링크 공유 보고서에는 지정된 기간 동안 조직 내의 내부 및 외부 사용자와 공유된 자산에 대한 모든 URL이 나열됩니다. 또한 링크가 공유된 시기, 누가, 언제 만료되는지 알려줍니다.

![](assets/navigatereport.png)

**사용 보고서에 액세스할 수 있도록 시작 지점을 수정했습니다.**
사용 보고서는 이제 다른 보고서와 통합되어 이제 자산 보고서 콘솔에서 볼 수 있습니다. 자산 보고서 콘솔에 도달하려면 **보고서 만들기/관리** 관리 도구 패널에서 액세스

![](assets/accessassetreport.png)

**보고 기능이 향상된 사용자 경험**
Brand Portal에 대한 보고 인터페이스가 더욱 직관적이 되었으며 조직의 제어를 강화했습니다. 다양한 보고서를 만들 수 있을 뿐만 아니라 관리자는 이제 생성된 보고서를 다시 방문하여 Brand Portal에 저장되므로 다운로드하거나 삭제할 수 있습니다.
...
이제 사용자는 새로운 기능을 사용하여 Brand Portal에 대한 액세스를 요청할 수 있습니다 **액세스 필요** Brand Portal의 로그인 화면에서 사용할 수 있는 기능입니다.
...
자세한 내용은 [Brand Portal에 대한 액세스 요청](../using/brand-portal.md#requestaccesstobrandportal).
...
자세한 내용은 [링크로 자산 공유](../using/brand-portal-link-share.md#shareassetsasalink).
