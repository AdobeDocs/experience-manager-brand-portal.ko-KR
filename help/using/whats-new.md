...
Brand Portal 2024.02.0은 중요 문제에 대한 수정 사항이 포함된 내부 릴리스입니다. 최신 [Brand Portal 릴리스 노트](brand-portal-release-notes.md)를 참조하십시오.
...
Brand Portal 2023.05.0은 중요 문제에 대한 수정 사항이 포함된 내부 릴리스입니다. 최신 [Brand Portal 릴리스 노트](brand-portal-release-notes.md)를 참조하십시오.

## 2023.02.0에서 변경된 사항 {#what-changed-in-February-2023}

Brand Portal 2023.02.0은 중요 문제에 대한 수정 사항이 포함된 내부 릴리스입니다. 최신 [Brand Portal 릴리스 노트](brand-portal-release-notes.md)를 참조하십시오.

## 2022.10.0의 변경 사항 {#what-changed-in-October-2022}

Brand Portal 2022.10.0은 중요한 문제에 대한 수정 사항이 포함된 내부 릴리스입니다. 최신 [Brand Portal 릴리스 노트](brand-portal-release-notes.md)를 참조하십시오.

## 2022.08.0의 변경 사항 {#what-changed-in-August-2022}

Brand Portal 2022.08.0은 중요 문제에 대한 수정 사항이 포함된 내부 릴리스입니다. 최신 [Brand Portal 릴리스 노트](brand-portal-release-notes.md)를 참조하십시오.

## 2022.05.0의 변경 사항 {#what-changed-in-May-2022}

이제 Brand Portal은 12시간마다 자동 작업을 실행하여 AEM에 게시된 모든 Brand Portal 자산을 삭제합니다. 따라서 폴더 크기를 임계값 제한 이하로 유지하기 위해 기여도 폴더에 에셋을 수동으로 삭제할 필요가 없습니다. Brand Portal의 **[!UICONTROL 도구]** > **[!UICONTROL 자산 기여 상태]** > **[!UICONTROL 삭제 보고서]** 옵션을 사용하여 자동으로 실행된 삭제 작업의 상태를 모니터링할 수도 있습니다. 작업 보고서는 다음 세부 정보를 제공합니다.
...
Brand Portal 2021.02.0은 AEM Assets에서 Brand Portal 활성화 워크플로 를 도입하고, as a Cloud Service에서 자산 소싱 을 용이하게 하고, AEM Assetsas a Cloud Service 에서 자산 다운로드 경험을 개선하고, 중요한 수정 사항을 포함하는 향상된 릴리스입니다. 또한 관리자는 테넌트 수준에서 폴더, 컬렉션 및 에셋의 대량 다운로드의 기본 다운로드 동작을 구성할 수 있습니다. 활성 Brand Portal 사용자를 반영하도록 Brand Portal **[!UICONTROL 사용 보고서]**&#x200B;도 수정되었습니다.

### Cloud Service로 AEM Assets에서 Brand Portal 활성화 {#bp-automation-on-cloud-service}

AEM Assets Cloud Service는 이제 사전 구성된 Brand Portal 인스턴스를 가질 수 있습니다. Cloud Manager 사용자는 AEM Assets에서 Brand Portal Cloud Service 인스턴스으로 활성화할 수 있습니다.
...
![보기 상태](assets/create-environment5.png)

Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/brand-portal/configure-aem-assets-with-brand-portal.html)로 AEM Assets에서 Brand Portal 활성화를 참조하십시오[.

### Cloud Service로서의 AEM Assets에 대한 자산 소싱 {#asset-sourcing-on-cloud-service}

이제 AEM Assetsas a Cloud Service 에서 에셋 소싱 기능을 사용할 수 있습니다. 이 기능은 기본적으로 모든 클라우드 서비스 사용자에 대해 활성화됩니다. 허가된 Brand Portal 사용자는 새 에셋을 기여 폴더에 업로드하고 Brand Portal의 기여 폴더를 AEM Assets as a Cloud Service 인스턴스로 게시하여 에셋 소싱에 기여할 수 있습니다. 관리자는 Brand Portal 사용자의 기여도를 검토하고 승인하여 다른 Brand Portal 사용자에게 추가로 배포할 수 있습니다.

이전에는 AEM Assets(온프레미스 및 관리 서비스)에서만 에셋 소싱을 사용할 수 있었습니다.

[Brand Portal의 자산 소싱](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/asset-sourcing-in-brand-portal/brand-portal-asset-sourcing.html?lang=ko-KR)을 참조하세요.
...
이전에는 모든 에셋 렌디션이 zip 폴더에 직접 다운로드되었습니다. 폴더 및 컬렉션에 대해 **[!UICONTROL 다운로드]** 대화 상자를 건너뛰었으며 에셋의 다운로드 동작을 제어할 수 있는 방법이 없으므로 많은 다운로드에서 특정 렌디션을 검색하기가 어렵습니다.
...
[Brand Portal에서 에셋 다운로드](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/download/brand-portal-download-assets.html)를 참조하십시오.
<!--
...
Brand Portal 2020.10.0은 자산 다운로드 경험을 단순화하는 데 중점을 둔 개선 릴리스이며, 중요한 수정 사항이 포함되어 있습니다. 향상된 기능에는 에셋 다운로드를 위한 새롭고 개선된 워크플로, 렌디션을 제외하는 추가 옵션, **[!UICONTROL 렌디션]** 패널에서 직접 다운로드, 특정 사용자 그룹의 액세스 및 다운로드 권한을 허용하는 구성, 모든 Brand Portal 페이지에서 파일, 컬렉션 및 공유 링크를 쉽게 탐색하는 기능이 포함되어 있습니다. 최신 [Brand Portal 릴리스 정보](brand-portal-release-notes.md)를 참조하세요.


### 간소화된 다운로드 환경 {#download-dialog}

이전에는 **[!UICONTROL 다운로드]** 대화 상자에 각 에셋에 대한 별도의 폴더 만들기, 이메일 에셋, 원본 에셋, 사용자 지정 렌디션, 동적 렌디션, 시스템 렌디션 제외, 다운로드 가속화 사용 등의 여러 옵션이 표시되었지만, 다운로드하기 위해 여러 에셋 또는 폴더를 선택할 때는 비기술적 사용자나 신규 사용자에게 특히 모호했습니다. 또한, 모든 에셋 렌디션을 보거나 특정 사용자 지정 또는 동적 렌디션을 제외할 수 없습니다.

새 **[!UICONTROL 다운로드]** 대화 상자는 에셋 선택 및 필터링 프로세스를 일반화하여 Brand Portal 사용자가 에셋 렌디션을 다운로드하는 동안 효과적인 결정을 쉽게 내릴 수 있도록 합니다. [**[!UICONTROL 다운로드]**](brand-portal-download-assets.md) 구성 및 **[!UICONTROL 다운로드]** 설정에 따라 선택한 모든 에셋과 해당 렌디션이 나열됩니다.

>[!NOTE]
>
>이제 모든 사용자는 기본적으로 **[!UICONTROL 빠른 다운로드]**&#x200B;를 사용할 수 있으며, IBM에서 자산을 다운로드하기 전에 브라우저의 확장에 Brand Portal Aspera Connect 3.9.9(`https://www.ibm.com/docs/en/aspera-connect/3.9.9`)를 설치해야 합니다.
...
다운로드 워크플로우는 독립 실행형 에셋, 여러 에셋, 에셋이 포함된 폴더, 라이선스가 있는 에셋 또는 라이선스가 없는 에셋, 공유 링크를 사용한 에셋 다운로드에 대해 일정하게 유지됩니다. Brand Portal에서 자산을 다운로드하는 [단계](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/download/brand-portal-download-assets.html)를 참조하세요.
...
Brand Portal 2020.10.0에서 사용자는 **[!UICONTROL 다운로드]** 대화 상자를 열지 않고도 특정 렌디션을 제외하고 에셋 세부 정보 페이지의 렌디션 패널에서 직접 [선택한 렌디션을 다운로드](brand-portal-download-assets.md#download-assets-from-asset-details-page)할 수 있습니다.
...
Brand Portal 관리자는 기존 **[!UICONTROL 다운로드]** 구성 외에도 에셋 세부 정보 페이지에서 원본 에셋과 그 변환을 보고 다운로드하도록 다른 사용자 그룹에 대한 설정을 구성할 수 있습니다.
...
* [원본&#x200B;]**다운로드] 및**[!UICONTROL [표현물&#x200B;]**다운로드] 설정이 모두**[!UICONTROL &#x200B;켜져 있으면 선택한 그룹 사용자가 원본 자산과 해당 표현물을 보고 다운로드할 수 있습니다.
* 두 설정이 모두 꺼져 있으면 사용자는 원본 자산만 볼 수 있습니다. 자산 표현물은 자산 세부 사항 페이지에서 사용자에게 표시되지 않습니다.
...
[자산 다운로드 구성](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/download/brand-portal-download-assets.html#configure-download-permissions)을 참조하세요.
...
Brand Portal에서 에셋을 다운로드하는 기존 워크플로에서는 선택할 수 있는 여러 다운로드 옵션이 있는 **[!UICONTROL 다운로드]** 대화 상자가 나타날 수 밖에 없습니다.
...
최신 [Brand Portal 릴리스 정보](brand-portal-release-notes.md)를 참조하세요.
...
Brand Portal 6.4.5는 작성자 환경에 액세스하지 않아도 콘텐츠를 Brand Portal에 업로드하고 AEM Assets에 게시할 수 있는 기능을 Brand Portal 사용자(외부 에이전시/팀)에게 제공하는 데 중점을 둔 기능 릴리스입니다. 이 기능은 **[Brand Portal의 자산 소싱](brand-portal-asset-sourcing.md)**&#x200B;이라고 하며, 사용자가 자산을 기여하고 전 세계에 배포된 다른 Brand Portal 사용자와 공유할 수 있는 양방향 메커니즘을 제공하여 고객 경험을 향상시킵니다.
...
그런 다음 AEM 사용자는 기여도 폴더에 추가해야 하는 에셋 유형에 대한 간단한 개요를 업로드하고 기본 에셋을 **SHARED** 폴더에 업로드하여 Brand Portal 사용자에게 필요한 참조 정보가 있는지 확인하여 요구 사항을 정의합니다. 그런 다음 관리자는 새로 만든 **기여도** 폴더를 Brand Portal에 게시하기 전에 활성 Brand Portal 사용자에게 기여도 폴더에 대한 액세스 권한을 부여할 수 있습니다.


사용자가 **NEW** 폴더에 콘텐츠를 추가하고 나면 기여도 폴더를 다시 AEM 작성자 환경에 게시할 수 있습니다. 가져오기를 완료하고 AEM Assets 내에 새로 게시된 콘텐츠를 반영하는 데 몇 분 정도 걸릴 수 있습니다.
...
Brand Portal 6.4.4 이상에서는 필터링 창의 속성 술어에 대한 부분 텍스트 검색을 지원합니다. 부분 텍스트 검색을 허용하려면 검색 양식의 속성 조건자에서 **부분 검색**&#x200B;을 활성화해야 합니다.
...
>[!NOTE]
>
>**부분 검색** 확인란을 선택하면 기본적으로 **대소문자 구분 안 함**&#x200B;이 선택됩니다.
...
특정 테넌트 계정에서 Dynamic Media 렌디션을 미리 보고 다운로드하도록 허용하려면 관리자는 관리 도구 패널에서 **Video** 구성으로 **Dynamic Media 구성**(Dynamic Video를 가져오려면 비디오 서비스 URL(DM-Gateway URL) 및 등록 ID)을 지정해야 합니다.
...
그러나 AEM 작성자 인스턴스는 테넌트 별칭(대체) URL이 아닌 테넌트 ID URL로만 [구성](https://experienceleague.adobe.com/docs/experience-manager-65/assets/brandportal/configure-aem-assets-with-brand-portal.html)될 수 있습니다.
...
Brand Portal 사용자는 IBM Aspera Connect 기반의 빠른 다운로드를 적용하여 최고 25배 빠른 속도를 얻을 수 있으며 전 세계 위치에 상관없이 원활한 다운로드 경험을 누릴 수 있습니다. 조직에서 다운로드 가속화가 활성화된 경우 Brand Portal 또는 공유 링크에서 에셋을 더 빨리 다운로드하려면 사용자는 다운로드 대화 상자에서 **다운로드 가속화를 활성화** 옵션을 선택해야 합니다.

![](assets/donload-assets-dialog-2.png)

조직의 IBM Aspera 기반 가속 다운로드를 활성화하려면 관리자는 관리 도구 패널의 [일반 설정](brand-portal-general-configuration.md#allow-download-acceleration)에서 **다운로드 가속을 활성화** 옵션(기본적으로 비활성화됨)을 사용합니다. Brand Portal 및 공유 링크에서 에셋 파일을 더 빨리 다운로드하기 위한 사전 요구 사항 및 문제 해결 단계에 대해 자세히 알아보려면 [Brand Portal에서 다운로드를 가속화하기 위한 안내서](../using/accelerated-download.md#main-pars-header)를 참조하십시오.
...
* 속성 페이지 탐색에 _(p)_, 편집에 _(e)_, 복사 작업에 _(ctrl+c)_&#x200B;과 같은 새 키보드 단축키를 도입했습니다.
...
* 이제 목록 보기에는 로케일, 에셋 유형, 차원, 크기, 등급 및 게시 정보 외에 에셋의 파일 이름이 기본적으로 첫 번째 열에 표시됩니다. 새 **보기 설정**&#x200B;을 사용하여 목록 보기에 표시할 세부 정보의 양을 구성할 수 있습니다.
...
* 에셋 속성에 제공된 새로운 관련 Assets 기능입니다. AEM의 다른 소스/파생 에셋과 관련되고 Brand Portal에 게시된 Assets은 이제 Brand Portal에서 해당 관계가 그대로 유지되며 속성 페이지의 관련 에셋에 대한 링크도 제공됩니다.
...
* 이제 Assets 복제 대화 상자에서 공용 폴더 Brand Portal 확인란을 선택하여 AEM 6.3.2.1 및 6.4에서 Publish으로 게시된 AEM Assets Brand Portal을 Brand Portal의 일반 사용자가 공개적으로 사용할 수 있도록 할 수 있습니다.
...
자세한 내용은 [Brand Portal 유지 관리 알림](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/introduction/brand-portal.html)을 참조하세요.
