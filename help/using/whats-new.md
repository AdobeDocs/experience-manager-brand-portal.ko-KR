...
적절한 권한이 있는 Brand Portal 사용자는 여러 자산이 들어 있는 개별 자산 또는 폴더(.zip 파일)를 기여도 폴더에 업로드할 수 있습니다. 사용자는 여러 자산을 자산 기여 폴더에 업로드할 수 있습니다. 그러나 한 번에 하나의 폴더만 만들 수 있습니다.

Brand Portal 사용자는 자산을 **신규** 하위 폴더. 다음 **공유** 폴더는 요구 사항 및 기준 요소 자산을 분배하기 위한 것입니다.
...
Brand Portal에서는 별표(&#42;)을 검색하십시오.

**사용 사례. 검색한 구문에서 발생하는 정확한 단어를 모를 경우 와일드카드 검색을 사용하여 검색 쿼리의 간격을 채울 수 있습니다.

예를 들어 **등벽&#42;** 문자로 시작하는 단어가 있는 모든 자산을 반환합니다 **등벽** 제목 구문에서 Brand Portal의 검색 양식이 자산 제목에서 부분 검색에 속성 설명을 사용하는 경우

![](assets/wildcard-prop.png)

마찬가지로, 다음을 지정합니다.

* **&#42;등벽** 문자로 끝나는 단어가 포함된 모든 자산을 반환합니다 **등벽** 제목 구문에

* **&#42;등벽&#42;** 문자를 포함하는 단어가 있는 모든 자산을 반환합니다 **등벽** 제목 구문에
