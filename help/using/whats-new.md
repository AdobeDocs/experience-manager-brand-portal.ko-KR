...
Brand Portal 2024.02.0은 중요한 문제에 대한 수정 사항이 포함된 내부 릴리스입니다. 최신 [Brand Portal 릴리스 정보](brand-portal-release-notes.md)를 참조하세요.

## 2023.10.0의 변경 사항 {#what-changed-in-October-2023}

Brand Portal 2023.10.0은 중요한 문제에 대한 수정 사항이 포함된 내부 릴리스입니다. 최신 [Brand Portal 릴리스 정보](brand-portal-release-notes.md)를 참조하세요.

## 2023.08.0의 변경 사항 {#what-changed-in-August-2023}

Brand Portal 2023.08.0은 중요한 문제에 대한 수정 사항이 포함된 내부 릴리스입니다. 최신 [Brand Portal 릴리스 정보](brand-portal-release-notes.md)를 참조하세요.

## 2023.05.0의 변경 사항 {#what-changed-in-May-2023}

Brand Portal 2023.05.0은 중요한 문제에 대한 수정 사항이 포함된 내부 릴리스입니다. 최신 [Brand Portal 릴리스 정보](brand-portal-release-notes.md)를 참조하세요.

## 2023.02.0의 변경 사항 {#what-changed-in-February-2023}

Brand Portal 2023.02.0은 중요한 문제에 대한 수정 사항이 포함된 내부 릴리스입니다. 최신 [Brand Portal 릴리스 정보](brand-portal-release-notes.md)를 참조하세요.

## 2022.10.0의 변경 사항 {#what-changed-in-October-2022}

Brand Portal 2022.10.0은 중요한 문제에 대한 수정 사항이 포함된 내부 릴리스입니다. 최신 [Brand Portal 릴리스 정보](brand-portal-release-notes.md)를 참조하세요.

## 2022.08.0의 변경 사항 {#what-changed-in-August-2022}

Brand Portal 2022.08.0은 중요한 문제에 대한 수정 사항이 포함된 내부 릴리스입니다. 최신 [Brand Portal 릴리스 정보](brand-portal-release-notes.md)를 참조하세요.

## 2022.05.0의 변경 사항 {#what-changed-in-May-2022}

이제 Brand Portal은 12시간마다 작업을 자동으로 실행하여 AEM에 게시된 모든 Brand Portal 에셋을 삭제합니다. 따라서 폴더 크기를 임계값 제한 이하로 유지하기 위해 기여도 폴더에 에셋을 수동으로 삭제할 필요가 없습니다. Brand Portal의 **[!UICONTROL 도구]** > **[!UICONTROL 자산 기여 상태]** > **[!UICONTROL 삭제 보고서]** 옵션을 사용하여 자동으로 실행되는 삭제 작업의 상태를 모니터링할 수도 있습니다. 작업 보고서는 다음 세부 정보를 제공합니다.
...
또한 Brand Portal 2022.05.0에는 중요한 문제에 대한 수정 사항이 포함되어 있습니다. 최신 [Brand Portal 릴리스 정보](brand-portal-release-notes.md)를 참조하세요.


## 2022.02.0의 변경 사항 {#what-changed-in-Feb-2022}

Brand Portal 2022.02.0은 중요한 문제에 대한 수정 사항이 포함된 내부 릴리스입니다. 최신 [Brand Portal 릴리스 정보](brand-portal-release-notes.md)를 참조하세요.

## 2021.10.0의 변경 사항 {#what-changed-in-october-2021}

Brand Portal 2021.10.0은 중요한 문제에 대한 수정 사항이 포함된 내부 릴리스입니다. 최신 [Brand Portal 릴리스 정보](brand-portal-release-notes.md)를 참조하세요.

## 2021.08.0의 변경 사항 {#what-changed-in-august-2021}

Brand Portal 2021.08.0은 기업이 자산을 더 잘 제어할 수 있도록 기업 및 팀 고객을 위한 비즈니스 프로필을 도입하는 내부 릴리스입니다. 이제 사용자는 새 조직과 마이그레이션된 조직에서 조직별 권한을 갖습니다. 마이그레이션하는 동안 기존의 모든 Adobe ID 계정이 Business ID로 마이그레이션됩니다.

* 마이그레이션된 후 모든 신규 및 기존 조직에 대한 Business ID.
...
Brand Portal 2021.06.0은 중요한 문제에 대한 수정 사항이 포함된 내부 릴리스입니다. 최신 [Brand Portal 릴리스 정보](brand-portal-release-notes.md)를 참조하세요.


## 2021.02.0의 변경 사항 {#what-changed-in-feb-2021}

Brand Portal 221.02.0은 AEM Assets 활성화 워크플로우 및 자산 소싱 기능을 통해 as a Cloud Service을 개선합니다. 또한 에셋 다운로드 경험을 개선하고 중요한 수정 사항을 포함합니다. 또한 관리자는 테넌트 수준에서 폴더, 컬렉션 및 에셋의 대량 다운로드의 기본 다운로드 동작을 구성할 수 있습니다. 활성 Brand Portal 사용자를 반영하도록 Brand Portal **[!UICONTROL 사용 보고서]**&#x200B;도 수정되었습니다.

### AEM Assetsas a Cloud Service 에서 Brand Portal 활성화 {#bp-automation-on-cloud-service}

이제 AEM Assetsas a Cloud Service 에 사전 구성된 Brand Portal 인스턴스가 있을 수 있습니다. Cloud Manager 사용자는 AEM Assets as a Cloud Service 인스턴스에서 Brand Portal을 활성화할 수 있습니다.

이전에는 AEM Assetsas a Cloud Service 가 Adobe Developer Console을 사용하여 Brand Portal으로 수동으로 구성되었습니다.
...
1. Cloud Manager Adobe에 로그인하고 **[!UICONTROL 환경]**(으)로 이동합니다.
1. 목록에서 환경을 하나씩 선택합니다. Brand Portal과 연결된 환경을 찾으면 **[!UICONTROL Brand Portal 활성화]** 단추를 클릭하여 활성화 워크플로를 시작합니다.
...
이제 AEM Assetsas a Cloud Service 에서 에셋 소싱 기능을 사용할 수 있습니다. 이 기능은 기본적으로 모든 클라우드 서비스 사용자에 대해 활성화됩니다. Brand Portal 허가된 권한은 새 자산을 기여 폴더에 업로드하고 Brand Portal의 기여 폴더를 AEM Assets as a Cloud Service 인스턴스로 게시하여 자산 소싱에 기여할 수 있습니다. 관리자는 Brand Portal 사용자의 기여를 검토하고 승인한 후 다른 사용자에게 분배할 수 있습니다.
...
이제 기존 **[!UICONTROL 다운로드 설정]** 외에도 Brand Portal 관리자는 **[!UICONTROL 에셋 다운로드]** 설정을 구성할 수 있습니다. 이 설정을 통해 관리자는 테넌트 수준에서 폴더, 컬렉션 및 에셋의 대량 다운로드(20개 이상의 에셋)의 기본 다운로드 동작을 제어할 수 있습니다.
...
이전에는 모든 에셋 렌디션이 zip 폴더에 직접 다운로드되었습니다. 폴더 및 컬렉션에 대한 **[!UICONTROL 다운로드]** 대화 상자를 건너뛰었습니다. 또한 에셋의 다운로드 동작을 제어할 방법이 없어 많은 다운로드에서 특정 렌디션을 검색하기 어려웠습니다.

**[!UICONTROL 에셋 다운로드]** 설정은 이제 폴더, 컬렉션 또는 에셋의 대량 다운로드를 다운로드하는 동안 각 에셋에 대해 별도의 폴더를 만드는 옵션을 제공합니다.

**[!UICONTROL 에셋 다운로드]** 설정을 사용하지 않도록 설정하면 폴더 또는 컬렉션이 공유 링크를 사용하여 에셋을 다운로드하는 경우를 제외하고 동일한 폴더 아래에 모든 에셋 렌디션이 들어 있는 zip 폴더로 다운로드됩니다.


관리자로 Brand Portal 테넌트에 로그인하고 **[!UICONTROL 도구]** > **[!UICONTROL 다운로드]**&#x200B;로 이동합니다. 관리자는 폴더, 컬렉션 및 일괄 에셋 다운로드를 다운로드하는 동안 **[!UICONTROL 에셋 다운로드]** 설정을 사용하여 각 에셋에 대해 별도의 폴더를 만들 수 있습니다.
...
Brand Portal **[!UICONTROL 사용 보고서]**&#x200B;가 활성 Brand Portal 사용자만 반영하도록 수정되었습니다. Admin Console의 제품 프로필에 할당되지 않은 Brand Portal 사용자는 비활성 사용자로 간주되며 **[!UICONTROL 사용 보고서]**&#x200B;에 반영되지 않습니다.
...
Brand Portal 2020.10.0은 자산 다운로드 경험을 단순화하는 데 중점을 둔 개선 릴리스이며 중요한 수정 사항이 포함되어 있습니다. 향상된 기능은 **[!UICONTROL 렌디션]** 패널에서 렌디션 및 직접 다운로드를 제외하는 옵션과 함께 에셋 다운로드를 위한 새롭고 개선된 워크플로우를 도입했습니다. 또한 특정 사용자 그룹에 대한 액세스 및 다운로드 권한을 구성하고 모든 Brand Portal 페이지에서 파일, 컬렉션 및 공유 링크를 쉽게 탐색할 수 있습니다. [Brand Portal 릴리스 정보](brand-portal-release-notes.md)를 참조하세요.


### 간소화된 다운로드 환경 {#download-dialog}

이전에는 **[!UICONTROL 다운로드]** 대화 상자에서 각 에셋에 대한 별도의 폴더 만들기, 에셋 이메일 전송, 원본 에셋 선택 등과 같은 여러 옵션을 제공했습니다. 이러한 옵션은 특히 여러 에셋 또는 폴더를 다운로드할 때 비기술적 사용자나 신규 사용자에게 혼동을 주었습니다. 또한, 모든 에셋 렌디션을 보거나 특정 사용자 지정 또는 동적 렌디션을 제외할 수 없습니다.

새 **[!UICONTROL 다운로드]** 대화 상자는 에셋 선택 및 필터링 프로세스를 일반화하여 Brand Portal 사용자가 에셋 렌디션을 다운로드하는 동안 보다 쉽게 효과적인 결정을 내릴 수 있도록 합니다. [**[!UICONTROL 다운로드]**](brand-portal-download-assets.md) 구성 및 **[!UICONTROL 다운로드]** 설정에 따라 선택한 모든 에셋과 해당 렌디션이 나열됩니다.

>[!NOTE]
>
>이제 모든 사용자는 기본적으로 **[!UICONTROL 빠른 다운로드]**&#x200B;를 사용할 수 있으며, IBM에서 자산을 다운로드하기 전에 브라우저의 확장에 Brand Portal® [Aspera Connect 3.9.9](https://www.ibm.com/support/fixcentral/swg/selectFixes?parent=ibm~Other%20software&amp;product=ibm/Other+software/IBM+Aspera+Connect&amp;release=3.9.9&amp;platform=All&amp;function=all)을(를) 설치해야 합니다.
...
**[!UICONTROL 다운로드]** 대화 상자에서 다음과 같은 작업을 수행할 수 있습니다.
...
이전에는 **[!UICONTROL 파일]**, **[!UICONTROL 컬렉션]** 및 **[!UICONTROL 공유 링크]**&#x200B;를 보는 옵션이 숨겨져 있었으며 사용자가 다른 보기로 전환하려고 할 때마다 여러 번 클릭해야 했습니다.

Brand Portal 2020.10.0에서 사용자는 빠른 탐색 링크를 사용하여 모든 Brand Portal 페이지에서 한 번의 클릭으로 **[!UICONTROL 파일]**, **[!UICONTROL 컬렉션]** 및 **[!UICONTROL 공유 링크]**&#x200B;로 이동할 수 있습니다.

![collection-navigation](assets/collection-navigation.png)

### 향상된 렌디션 패널 {#rendition-panel}

이전에는 **[!UICONTROL 다운로드]** 구성에서 **[!UICONTROL 사용자 지정 렌디션]** 또는 **[!UICONTROL 시스템 렌디션]**&#x200B;을 사용하도록 설정한 경우에만 사용자가 **[!UICONTROL 렌디션]** 패널에서만 원본 에셋과 해당 렌디션을 볼 수 있었습니다. 또한, 필요하지 않은 특정 사용자 지정 또는 동적 변환을 제외하기 위한 필터가 없으므로 사용자는 모든 에셋 변환을 다운로드해야 했습니다.
...
Brand Portal 2020.10.0에서는 사용자가 **[!UICONTROL 다운로드]** 대화 상자를 열지 않고도 특정 렌디션을 제외하고 에셋 세부 정보 페이지의 렌디션 패널에서 직접 [선택한 렌디션을 다운로드](brand-portal-download-assets.md#download-assets-from-asset-details-page)할 수 있습니다.
...
이제 Brand Portal 관리자는 기존 **[!UICONTROL 다운로드]** 구성 외에 에셋 세부 정보 페이지에서 원본 에셋과 렌디션 또는 둘 다를 보거나 다운로드하도록 사용자 그룹에 대한 설정을 구성할 수 있습니다.

관리자로 Brand Portal 테넌트에 로그인하고 **[!UICONTROL 도구]** > **[!UICONTROL 사용자]**(으)로 이동합니다.
...
관리자는 **[!UICONTROL 사용자 역할]** 페이지의 **[!UICONTROL 그룹]** 탭에서 보기 및 다운로드 설정을 구성할 수 있습니다.

* **[!UICONTROL 원본 다운로드]** 및 **[!UICONTROL 렌디션 다운로드]** 설정이 모두 켜져 있으면 선택한 그룹의 사용자가 원본 에셋과 해당 렌디션을 보고 다운로드할 수 있습니다.
...
Brand Portal 6.4.7 릴리스는 Document Viewer를 도입하고 에셋 다운로드 경험을 개선하며 중요한 수정 사항을 포함합니다. 최신 [Brand Portal 릴리스 정보](brand-portal-release-notes.md)를 참조하세요.
...
Brand Portal 사용자는 Document Viewer를 사용하여 페이지 및 책갈피를 보고, 텍스트를 검색하고, 페이지를 확대/축소하고, 탐색할 수 있습니다. 특정 페이지로 전환하고, 창이나 화면에 맞추고, 도구 모음 가시성을 전환할 수 있습니다.
...
에셋 다운로드 프로세스가 개선되어 [Brand Portal에서 에셋을 다운로드](brand-portal-download-assets.md)하는 동안 간소화된 사용자 환경을 제공합니다.

Brand Portal에서 에셋을 다운로드하는 기존 워크플로우에는 선택할 수 있는 여러 다운로드 옵션이 있는 **[!UICONTROL 다운로드]** 대화 상자가 불가피하게 표시됩니다.

Brand Portal 6.4.7에서 Brand Portal 관리자는 에셋 **[!UICONTROL 다운로드]** 설정을 구성할 수 있습니다. 사용 가능한 구성은 다음과 같습니다.
...
* **[!UICONTROL 사용자 지정 렌디션]** 및 **[!UICONTROL 시스템 렌디션]** 구성이 모두 꺼져 있는 경우 추가 대화 상자 없이 에셋의 원본 렌디션이 다운로드되므로 Brand Portal 사용자의 다운로드 경험이 간소화됩니다.

* **[!UICONTROL 사용자 지정 렌디션]** 또는 **[!UICONTROL 시스템 렌디션]**&#x200B;을 사용하도록 설정한 경우 **[!UICONTROL 다운로드]** 대화 상자가 나타나고 원본 에셋과 에셋 렌디션이 다운로드됩니다. **[!UICONTROL 빠른 다운로드]** 구성을 사용하면 다운로드 프로세스가 빨라집니다.

구성에 따라 다운로드 워크플로우는 독립형 에셋, 여러 에셋 및 에셋이 포함된 폴더에 대해 일정하게 유지됩니다. 여기에는 라이센스가 부여되거나 라이선스가 없는 에셋과 공유 링크를 사용하여 에셋을 다운로드하는 작업도 포함됩니다.
...
>[!NOTE]
>
>Adobe은 최신 서비스 팩을 사용하도록 AEM 인스턴스를 업데이트할 것을 권장합니다.

[Brand Portal 릴리스 정보](brand-portal-release-notes.md)를 참조하세요.
...
Brand Portal 6.4.5를 사용하면 작성 환경에 액세스하지 않아도 외부 에이전시와 팀이 Brand Portal에 콘텐츠를 업로드하고 AEM Assets에 게시할 수 있습니다. 이 기능은 **[Brand Portal의 자산 소싱](brand-portal-asset-sourcing.md)**&#x200B;이라고 하며, 사용자가 자산을 기여하고 전 세계에 배포된 다른 Brand Portal 사용자와 공유할 수 있는 양방향 메커니즘을 제공하여 고객 경험을 향상시킵니다.

### Brand Portal의 에셋 소싱 {#asset-sourcing-in-bp}

에셋 소싱을 사용하면 AEM 사용자(관리자/관리자가 아닌 사용자)가 추가 **에셋 기여** 속성을 사용하여 폴더를 만들 수 있으므로 Brand Portal 사용자가 에셋 제출에 대해 만든 새 폴더를 열 수 있습니다. 새로 만든 **기여도** 폴더 내에 NEW 및 SHARED라는 두 개의 추가 하위 폴더를 만드는 워크플로를 자동으로 트리거합니다.

AEM 사용자가 간단한 기본 자산을 **SHARED** 폴더로 업로드합니다. 기여도 폴더에 필요한 에셋 유형을 정의하여 Brand Portal 사용자에게 필요한 참조 정보가 전달되도록 합니다. 그런 다음 관리자는 새로 만든 **기여도** 폴더를 Brand Portal에 게시하기 전에 활성 Brand Portal 사용자에게 기여도 폴더에 대한 액세스 권한을 부여할 수 있습니다.


사용자가 **NEW** 폴더에 콘텐츠를 추가하고 나면 기여도 폴더를 AEM Author 환경에 다시 게시할 수 있습니다. 가져오기를 완료하고 AEM Assets 내에 새로 게시된 콘텐츠를 반영하는 데 몇 분 정도 걸릴 수 있습니다.
...
Brand Portal 사용자는 **NEW** 하위 폴더에만 에셋을 업로드할 수 있습니다. **SHARED** 폴더는 요구 사항 및 기준 자산을 배포하기 위한 것입니다.
...
### AEM Assets에 대한 Publish 기여 폴더 {#publish-assets-to-aem}

**NEW** 폴더에 대한 업로드가 완료되면 Brand Portal 사용자는 기여도 폴더를 다시 AEM에 게시할 수 있습니다. AEM Assets에서 게시된 콘텐츠/에셋을 가져오고 반영하는 데 몇 분 정도 걸릴 수 있습니다. [기여도 폴더를 AEM Assets에 게시](brand-portal-publish-contribution-folder-to-aem-assets.md)를 참조하십시오.
...
Brand Portal 6.4.4 릴리스는 텍스트 검색 및 주요 고객 요청에 대한 개선 사항에 중점을 둡니다. 최신 [Brand Portal 릴리스 정보](brand-portal-release-notes.md)를 참조하세요.

### 검색 개선 사항

Brand Portal 6.4.4 이상에서는 필터링 창의 속성 조건부에서 부분 텍스트 검색을 지원합니다. 부분 텍스트 검색을 허용하려면 검색 양식의 속성 조건자에서 **부분 검색**&#x200B;을 사용하도록 설정하십시오.

부분 텍스트 검색 및 와일드카드 검색에 대한 자세한 내용은 계속 읽으십시오.

#### 부분 구문 검색 {#partial-phrase-search}

이제 필터링 창에서 검색한 구문의 일부만(즉, 한 단어 또는 두 단어) 지정하여 자산을 검색할 수 있습니다.

**사용 사례**
부분 구문 검색은 검색된 구문에서 발생하는 정확한 단어 조합을 모를 때 유용합니다.

예를 들어, Brand Portal의 검색 양식에서 자산 제목의 부분 검색을 위해 속성 조건자를 사용하는 경우 **camp**&#x200B;라는 용어를 지정하면 제목 구문에 camp라는 단어가 포함된 모든 자산이 반환됩니다.

![](assets/partialphrasesearch.png)

#### 와일드카드 검색 {#wildcard-search}

Brand Portal에서는 검색 쿼리의 단어 일부에 별표(&#42;)를 사용할 수 있습니다.

검색된 구문에서 발생하는 정확한 단어를 모를 경우 와일드카드 검색을 사용하여 검색 쿼리의 간격을 채울 수 있습니다.

예를 들어 Brand Portal의 검색 양식에서 자산 제목의 부분 검색에 대해 속성 조건자를 사용하는 경우 **climb&#42;**&#x200B;을 지정하면 제목 구문에 **climb** 문자로 시작하는 단어가 포함된 모든 자산이 반환됩니다.

![](assets/wildcard-prop.png)

마찬가지로, 다음을 지정합니다.

* **&#42;climb**&#x200B;은(는) 제목 구문에 **climb** 문자로 끝나는 단어가 포함된 모든 자산을 반환합니다.

* **&#42;climb&#42;**&#x200B;은(는) 제목 구문에 **climb** 문자를 포함하는 단어가 있는 모든 자산을 반환합니다.

>[!NOTE]
>
>**부분 검색** 확인란을 선택하면 기본적으로 **대/소문자 구분 안 함**&#x200B;이 선택됩니다.
...
Brand Portal 6.4.3에는 액세스 URL에 대한 대체 별칭, 새 폴더 계층 구조 및 비디오 지원 개선 사항이 도입되었습니다. 또한 AEM Author에서 Brand Portal으로 예약된 게시, 운영 개선 사항을 소개하고 고객 요청을 해결합니다.

### 관리자가 아닌 사용자를 위한 폴더 계층 구조 탐색

이제 관리자는 로그인 시 관리자가 아닌 사용자(편집자, 뷰어 및 게스트 사용자)에게 폴더를 표시하는 방법을 구성할 수 있습니다. [폴더 계층 구조 사용](../using/brand-portal-general-configuration.md) 구성이 관리 도구 패널의 **일반 설정**&#x200B;에 추가되었습니다. 구성이 다음과 같은 경우

* **enabled**, 루트 폴더에서 시작하는 폴더 트리가 관리자가 아닌 사용자에게 표시됩니다. 따라서 관리자에게 관리자와 유사한 탐색 경험을 제공할 수 있습니다.
* **비활성화됨**. 공유 폴더만 랜딩 페이지에 표시됩니다.

![](assets/enable-folder-hierarchy.png)

[폴더 계층 구조 사용](../using/brand-portal-general-configuration.md) 기능(활성화된 경우)을 사용하면 다른 계층에서 공유되는 같은 이름의 폴더를 구분할 수 있습니다. 이제 로그인하면 관리자가 아닌 사용자에게 공유 폴더의 가상 상위(및 상위) 폴더가 표시됩니다.
...
**경로 브라우저** 조건자가 검색 양식에 도입되어 특정 디렉터리에서 자산을 검색할 수 있습니다. 경로 브라우저에 대한 검색 조건자의 기본 검색 경로는 `/content/dam/mac/<tenant-id>/`이며, 기본 검색 양식을 편집하여 구성할 수 있습니다.

* 관리자 사용자는 경로 브라우저를 사용하여 Brand Portal의 모든 폴더 디렉토리로 이동할 수 있습니다.
* 관리자가 아닌 사용자는 경로 브라우저를 사용하여 공유된 폴더(및 상위 폴더로 다시 이동)만 탐색할 수 있습니다.

  예를 들어 `/content/dam/mac/<tenant-id>/folderA/folderB/folderC`은(는) 관리자가 아닌 사용자와 공유됩니다. 사용자는 경로 브라우저를 사용하여 folderC 내에서 에셋을 검색할 수 있습니다. 이 사용자는 folderB 및 folderA(사용자와 공유되는 folderC의 상위 항목이므로)로 이동할 수도 있습니다.
...
특정 테넌트 계정에서 Dynamic Media 렌디션의 미리 보기 및 다운로드를 활성화하려면 관리자는 **Dynamic Media 구성**&#x200B;을(를) 지정합니다. 이 단계에는 관리 도구 패널의 **비디오** 구성에 있는 비디오 서비스 URL 및 등록 ID가 포함됩니다.
...
AEM 6.4.2.0 작성자 인스턴스에서 Brand Portal으로 Assets(및 폴더) 게시 워크플로우를 나중 날짜, 시간으로 예약할 수 있습니다.
...
예를 들어 기존 도메인 **geometrix.brand-portal.adobe.com**&#x200B;을(를) 가진 조직은 요청 시 **geometrixinc.brand-portal.adobe.com**&#x200B;을(를) 만들 수 있습니다.

그러나 AEM 작성자 인스턴스는 테넌트 별칭(대체) URL이 아닌 테넌트 ID URL로만 [구성](https://experienceleague.adobe.com/ko/docs/experience-manager-65/content/assets/brandportal/configure-aem-assets-with-brand-portal)될 수 있습니다.
...
이 릴리스에서는 다음과 같이 클릭 수 및 경고 수가 줄어들어 다운로드 경험이 간소화됩니다.
...
AEM Brand Portal은 게스트가 포털에 액세스할 수 있도록 허용합니다. 게스트 사용자는 포털에 로그인하기 위해 자격 증명이 필요하지 않으며 모든 공개 폴더 및 컬렉션에 액세스하고 다운로드할 수 있습니다. 게스트 사용자는 Lightbox(개인 컬렉션)에 자산을 추가하고 다운로드할 수 있습니다. 스마트 태그 검색과 관리자가 설정한 검색 술어를 볼 수도 있습니다. 게스트 세션에서는 사용자가 컬렉션과 저장된 검색을 만들거나 더 이상 공유하고, 폴더 및 컬렉션 설정에 액세스하며, 자산을 링크로 공유할 수 없습니다.
...
Brand Portal 사용자는 IBM® Aspera Connect 기반 빠른 다운로드를 적용하여 최고 25배 빠른 속도를 구현하고 전 세계 위치에 상관없이 원활한 다운로드 경험을 누릴 수 있습니다. 조직에서 다운로드 가속화가 활성화된 경우 Brand Portal 또는 공유 링크에서 에셋을 더 빨리 다운로드하려면 사용자는 다운로드 대화 상자에서 **다운로드 가속화를 활성화** 옵션을 선택해야 합니다.

![](assets/donload-assets-dialog-2.png)

조직에 대해 IBM® Aspera 기반 가속 다운로드를 활성화하려면 관리자는 관리 도구 패널의 [일반 설정](brand-portal-general-configuration.md#allow-download-acceleration)에서 **다운로드 가속을 활성화** 옵션(기본적으로 비활성화됨)을 사용합니다.

Brand Portal 및 공유 링크에서 에셋 파일을 더 빨리 다운로드하기 위한 사전 요구 사항 및 문제 해결 단계는 [Brand Portal에서 다운로드 속도를 높이기 위한 안내서](../using/accelerated-download.md#main-pars-header)를 참조하십시오.

### 사용자 로그인 보고서

이제 사용자 로그인을 추적하는 새 보고서가 도입되었습니다. **사용자 로그인** 보고서는 조직에서 위임된 관리자 및 Brand Portal의 다른 사용자를 감사하고 확인할 수 있도록 하는 데 유용합니다.

보고서 로그 Brand Portal 6.4.2 배포에서 보고서 생성 시간까지 표시 이름, 이메일 ID, 가상 사용자(관리자, 뷰어, 편집기, 게스트), 그룹, 마지막 로그인, 활동 상태 및 각 사용자의 로그인 수를 기록합니다. 관리자는 보고서를 .csv 로 내보낼 수 있습니다. 다른 보고서와 함께 사용자 로그인 보고서를 통해 조직은 승인된 브랜드 리소스와의 사용자 상호 작용을 면밀히 모니터링하여 기업 규정 준수 사무소에 대한 적합성을 보장할 수 있습니다.

![](assets/user-logins-1.png)

### 원본 렌디션에 액세스

관리자는 원본 이미지 파일에 대한 액세스를 제한하고 Brand Portal 또는 공유 링크에서 다운로드할 저해상도 표현물에 대한 액세스를 제공할 수 있습니다. 이 액세스는 사용자 역할 페이지의 그룹 탭에서 사용자 그룹 수준에서 제어할 수 있습니다.
...
이제 카드 보기에서 폴더 카드에 관리자가 아닌 사용자(편집자, 뷰어 및 게스트 사용자)에게 폴더 계층 구조 정보가 표시됩니다. 이 기능을 사용하면 상위 계층 구조를 기준으로 액세스하는 폴더의 위치를 알 수 있습니다.

폴더 계층 구조 정보는 폴더를 구분하는 데 특히 유용합니다. 즉, 다른 폴더 계층에서 공유되는 다른 폴더와 유사한 이름을 갖는 폴더이다. 관리자가 아닌 사용자가 공유된 에셋의 폴더 구조를 알지 못하는 경우 유사한 이름의 에셋/폴더가 혼동되는 것으로 보입니다.

* 각 카드에 표시된 경로는 카드 크기에 맞게 잘립니다. 그러나 사용자는 잘린 경로 위로 마우스를 가져가면 전체 경로를 도구 설명으로 볼 수 있습니다.

![](assets/folder-hierarchy1-1.png)

목록 보기에는 모든 Brand Portal 사용자에 대한 열에 에셋의 폴더 경로가 표시됩니다.
...
1. 도구 모음의 맨 위에서 에셋/폴더 선택 시
2. 드롭다운에서 레일 선택기 선택 시

개요 옵션을 선택할 때 에셋/폴더가 선택되어 있는 동안 사용자는 에셋 생성의 제목, 경로 및 시간을 볼 수 있습니다. 반면에 에셋 세부 정보 페이지에서는 개요 옵션을 선택하여 에셋의 메타데이터를 볼 수 있습니다.
...
관리자가 특정 테넌트에서 다음 기능을 활성화하거나 비활성화할 수 있도록 6개의 새 구성이 추가되었습니다.
...
Brand Portal 6.4.2 이상에서는 기존 OAuth(`https://legacy-oauth.cloud.adobe.io/`) 인터페이스를 사용하여 JWT 애플리케이션을 만듭니다. 이를 통해 AEM Assets과 Brand Portal의 통합을 허용하는 oAuth 통합을 구성할 수 있습니다. 이전에는 OAuth 통합 구성을 위한 UI가 `https://marketing.adobe.com/developer/`에서 호스팅되었습니다. AEM Assets과 Brand Portal을 통합하여 Brand Portal에 자산 및 컬렉션을 게시하는 방법에 대한 자세한 내용은 [Brand Portal과 AEM Assets 통합 구성](https://experienceleague.adobe.com/ko/docs/experience-manager-65/content/assets/brandportal/configure-aem-assets-with-brand-portal)을 참조하세요.

## 검색 개선 사항

관리자는 대소문자 구분 안 함 확인란이 있는 업데이트된 속성 술어를 사용하여 속성 술어를 대소문자를 구분하지 않게 할 수 있습니다. 이 옵션은 속성 술어 및 다중 값 속성 술어에 사용할 수 있습니다.\
하지만 대소문자를 구분하지 않는 검색은 속성 조건자에 대한 기본 검색보다 상대적으로 느립니다. 검색 필터에 대소문자를 구분하지 않는 술어가 너무 많으면 검색 속도가 느려질 수 있습니다. Adobe은 대/소문자를 구분하지 않는 검색을 신중하게 사용할 것을 권장합니다.

## 6.4.1의 변경 사항 {#what-changed-in-2}

Brand Portal 6.4.1은 플랫폼 업그레이드 릴리스입니다. 브라우징, 검색 및 성능 향상과 같은 몇 가지 새로운 기능과 중요한 개선 사항을 소개합니다.

### 향상된 찾아보기

* 새로운 콘텐츠 트리 레일을 통해 사용자는 에셋 계층 구조를 빠르게 탐색할 수 있습니다.

![](assets/contenttree-2.png)

* 새 키보드 단축키(예: 속성 페이지 탐색의 경우 _(p)_, 편집의 경우 _(e)_, 복사 작업의 경우 _(ctrl+c)_).
* 많은 수의 에셋을 탐색할 수 있도록 카드 및 목록 보기에서 스크롤링, 소극적 로드 경험이 개선되었습니다.
...
* 에셋의 세부 정보 페이지로 이동할 수 있도록 에셋 스냅숏 아래에 **추가 세부 정보**&#x200B;가 있는 열 보기가 개선되었습니다.

![](assets/columnmoredetail.png)

* 이제 목록 보기에는 기본적으로 첫 번째 열에 에셋의 파일 이름이 표시됩니다. 로케일, 에셋 유형, 차원, 크기, 등급 및 게시 정보도 표시됩니다. 새 **보기 설정**&#x200B;을 사용하여 목록 보기에 표시할 세부 정보의 양을 구성할 수 있습니다.
...
* 에셋 속성에 제공된 새로운 관련 Assets 기능입니다. AEM의 Brand Portal에 게시된 관련 에셋은 이제 속성 페이지에서 사용할 수 있는 이러한 관련 에셋에 대한 링크를 통해 관계를 유지합니다.
...
* 검색 결과 수를 표시하는 새 검색 결과 카운트가 제공되었습니다.
* 향상된 파일 유형 검색 필터를 사용하면 이미지, 문서 및 멀티미디어와 같은 광범위한 범주가 아닌 .jpg, .png 및 .psd와 같은 특정 MIME 유형별로 검색 결과를 필터링할 수 있습니다.
...
**참고**: 실험실에서 실시한 테스트에 따라 향상된 기능을 인용했습니다.

### 향상된 보고 기능

**링크 공유 보고서를 도입했습니다**
공유 링크에 대한 정보를 제공하는 새 보고서가 도입되었습니다. 링크 공유 보고서에는 내부 및 외부 사용자와 공유된 에셋에 대한 모든 URL이 나열됩니다. 지정된 시간대에 조직의 사용자에 대해 보고합니다. 또한 언제 링크가 공유되었고, 누구에 의해, 언제 만료되는지를 알려줍니다.

![](assets/navigatereport.png)

**사용 보고서에 액세스할 진입점을 수정했습니다**
사용 보고서는 이제 다른 보고서와 통합되었으며 이제 자산 보고서 콘솔에서 볼 수 있습니다. 자산 보고서 콘솔에 연결하려면 관리 도구 패널에서 **보고서 만들기/관리**(으)로 이동합니다.
...
기본 열을 추가하거나 제거하여 만들 각 보고서를 사용자 지정할 수 있습니다. 또한 사용자 정의 열을 다운로드, 만료 및 Publish 보고서에 추가하여 그 세부 정도를 제어할 수 있습니다.
...
* AEM 6.3.2.1 및 6.4에서 Brand Portal에 게시된 Assets은 이제 AEM Assets Brand Portal 복제 대화 상자에서 공용 폴더 Publish 상자를 선택하여 공개적으로 사용할 수 있습니다.

![](assets/public-folder-publish.png)

* 관리자는 Brand Portal 알림 영역의 알림과 별도로 누군가 Brand Portal에 대한 액세스를 요청한 경우 액세스 요청 이메일을 통해 알림을 받습니다.
...
이제 사용자는 Brand Portal의 로그인 화면에서 사용할 수 있는 새로운 **액세스 필요** 기능을 사용하여 Brand Portal에 대한 액세스를 요청할 수 있습니다.
...
자세한 내용은 [Brand Portal 액세스 요청](../using/brand-portal.md#requestaccesstobrandportal)을 참조하십시오.

### 다운로드한 에셋 보고서의 개선 사항 {#enhancement-in-the-assets-downloaded-report}

이제 다운로드된 에셋 보고서에는 지정된 날짜 및 시간 범위 내의 사용자당 에셋 다운로드 수가 포함됩니다. 사용자는 이 보고서를 .csv 형식으로 다운로드하여 라이선스가 있는 자산의 총 다운로드 수와 같은 데이터를 컴파일할 수 있습니다.

![](assets/reports_download_downloaded_by.png)

자세한 내용은 [추가 보고서 만들기 및 관리](../using/brand-portal-reports.md#createandmanageadditionalreports)의 3단계 및 6단계를 참조하십시오.
...
자세한 내용은 [링크로 에셋 공유](../using/brand-portal-link-share.md#shareassetsasalink)의 12단계를 참조하십시오.
...
* 검색 필터를 옴니 검색에 추가하여 검색 범위를 더욱 좁히고 신속하게 지정할 수도 있습니다.
...
중첩된 폴더를 다운로드한 후에는 원래 폴더 계층 구조를 유지할 수 있습니다. 중첩된 폴더 내의 Assets은 개별 폴더가 아니라 단일 폴더에서 다운로드할 수 있습니다.

### 향상된 성능 {#improved-performance}

찾아보기, 검색 및 다운로드 기능이 개선되어 Brand Portal 성능이 크게 향상되었습니다.

### 에셋용 새 Digital Rights Management {#new-digital-rights-management-for-assets}
...
관리자는 다운로드, 만료 및 게시된 세 가지 유형의 보고서 자산을 만들고 관리할 수 있습니다. 보고서에서 열을 구성하고 보고서를 CSV 형식으로 내보내는 기능도 사용할 수 있습니다.

![](assets/newreport.png)

### 추가 메타데이터 {#additional-metadata}

Brand Portal 6.3.1은 AEM Assets 6.3과 동등한 추가 메타데이터를 도입했습니다. 스키마 편집기 양식을 사용하여 Assets 속성 페이지에 표시되어야 하는 메타데이터를 제어할 수 있습니다. 링크 공유 URL을 사용해야만 에셋을 미리 보고 다운로드할 수 있는 외부 링크 공유 사용자는 에셋 메타데이터를 볼 수 없습니다.
...
* 관리자가 새 사용자를 추가하면 초대를 수락할 필요 없이 자동으로 Brand Portal에 포함됩니다.

### AEM Assets 6.3의 새로운 게시 기능 {#new-publishing-capabilities-in-aem-assets}

* AEM 관리자는 2017년 4분기에 사용 가능한 AEM 6.3 SP 1-CFP 1(6.3.1.1)을 사용하여 AEM Assets에서 Brand Portal으로 메타데이터 스키마를 게시할 수 있습니다.
