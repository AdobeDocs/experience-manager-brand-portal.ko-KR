...
>[!NOTE]
>
>이제 모든 사용자는 기본적으로 **[!UICONTROL 빠른 다운로드]**&#x200B;를 사용할 수 있으며, IBM에서 자산을 다운로드하기 전에 Brand Portal® Aspera Connect 3.9.9(`https://www.ibm.com/docs/en/aspera-connect/3.9.9`)를 브라우저의 확장에 설치해야 합니다.
