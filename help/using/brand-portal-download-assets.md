...
* **[!UICONTROL 사용자 지정 표현물]**
   ...
   원래 자산 및 시스템에서 생성한 표현물 이외의 모든 자산 표현물을 사용자 지정 표현물이라고 합니다. 여기에는 자산에 사용할 수 있는 동적 표현물 및 정적 표현물이 포함됩니다. 모든 사용자는 Experience Manager Assets에서 사용자 지정 정적 렌디션을 만들 수 있지만 관리자만 사용자 지정 동적 렌디션을 만들 수 있습니다. 자세한 내용은 [이미지 사전 설정 또는 동적 변환 적용 방법](../using/brand-portal-image-presets.md)을 참조하십시오.
