...
Adobe Experience Manager Assets Brand Portal은 사용자가 Brand Portal에서 액세스할 수 있는 여러 자산 및 폴더를 동시에 다운로드할 수 있도록 함으로써 다운로드 환경을 개선합니다. 이 방법으로 승인된 브랜드 자산은 오프라인에서 사용할 수 있도록 안전하게 분배할 수 있습니다. Brand Portal에서 승인된 자산을 다운로드하는 방법과 여기에서 무엇을 기대할 수 있는지 살펴보십시오 [성능 다운로드](../using/brand-portal-download-assets.md#expected-download-performance).
...
사용자는 다양한 표현물을 미리 보고 특정 표현물을 선택한 다음, **[!UICONTROL 표현물]** 패널을 열 필요 없이 자산 세부 사항 페이지의 패널 **[!UICONTROL 다운로드]** 대화 상자.
