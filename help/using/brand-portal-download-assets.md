...
# 브랜드 포털 {#download-assets-from-bp}에서 에셋 다운로드
...
브랜드 포털 관리자는 **[!UICONTROL 다운로드 설정]** 이외에 다른 사용자 그룹에 대해 원래 에셋 및 해당 표현물을 보고 다운로드할 권한을 추가로 구성할 수 있습니다.

관리자로 브랜드 포털 테넌트에 로그인하고 **[!UICONTROL 도구]** > **[!UICONTROL 사용자]**&#x200B;로 이동합니다. **[!UICONTROL 사용자 역할]** 페이지에서 **[!UICONTROL 그룹]** 탭으로 이동하여 사용자 그룹에 대한 보기 및 (또는) 다운로드 권한을 구성합니다.
...
>[!NOTE]
>
>변환에 액세스하거나 다운로드할 수 있는 권한이 없는 경우 브랜드 포털 관리자에게 문의하십시오.
...
>[!NOTE]
>
>**[!UICONTROL 다운로드]** 대화 상자는 자산을 다운로드하기 위해 선택하고 **[!UICONTROL 사용자 지정 표현물]** 또는 **[!UICONTROL 시스템 표현물]**&#x200B;이 **[!UICONTROL 다운로드 설정]**&#x200B;에서 활성화되어 있는 경우에만 나타납니다.
...
1. 선택한 모든 자산을 나열하는 **[!UICONTROL 다운로드]** 대화 상자가 열립니다.
   ...
   **제거** 아이콘을 클릭하여 다운로드 목록에서 자산을 제거할 수도 있습니다(필요한 경우).
   ...
   자산을 다운로드하는 동안 브랜드 포털 폴더 계층 구조를 유지하려면 **[!UICONTROL 각 에셋에 대해 별도의 폴더 만들기]** 확인란을 선택합니다. 기본적으로 브랜드 포털 폴더 계층 구조는 무시되며 모든 자산은 zip 폴더에 다운로드됩니다.
...
1. 기본적으로 **[!UICONTROL 빠른 다운로드]** 설정은 **[!UICONTROL 다운로드 설정]**&#x200B;에서 활성화됩니다. 따라서 IBM Aspera Connect를 사용하여 빠른 다운로드를 허용하는 확인 상자가 나타납니다.
   ...
   **[!UICONTROL 빠른 다운로드]**&#x200B;를 계속 사용하려면 **[!UICONTROL 허용]**&#x200B;을 클릭합니다. 선택한 모든 변환이 IBM Aspera Connect를 사용하여 zip 폴더에 다운로드됩니다.
   ...
   IBM Aspera Connect를 사용하지 않으려면 **[!UICONTROL 거부]**&#x200B;를 클릭합니다. **[!UICONTROL 빠른 다운로드]**&#x200B;가 거부되거나 실패한 경우, 시스템은 오류 메시지를 채웁니다. 에셋 다운로드를 계속하려면 **[!UICONTROL 일반 다운로드]** 단추를 클릭합니다. 선택한 변환은 IBM Aspera Connect를 사용하지 않고 zip 폴더에 다운로드됩니다.
...
>[!NOTE]
>
>다운로드용으로 폴더, 컬렉션 또는 20개 이상의 에셋을 선택한 경우 **[!UICONTROL 다운로드]** 대화 상자를 건너뛰고 동적 변환을 제외한 사용자가 액세스할 수 있는 모든 에셋 변환이 zip 폴더에 다운로드됩니다. 자산 표현물은 zip 폴더 내의 각 자산에 대해 별도의 폴더로 다운로드됩니다.
...
1. 기본적으로 **[!UICONTROL 빠른 다운로드]** 설정은 **[!UICONTROL 다운로드 설정]**&#x200B;에서 활성화됩니다. 따라서 IBM Aspera Connect를 사용하여 빠른 다운로드를 허용하는 확인 상자가 나타납니다.
   ...
   **[!UICONTROL 빠른 다운로드]** 사용을 거부하는 경우 시스템은 오류 메시지를 채웁니다. 다운로드를 계속하려면 **[!UICONTROL 일반 다운로드]** 단추를 클릭합니다. 선택한 변환은 IBM Aspera Connect를 사용하지 않고 zip 폴더에 다운로드됩니다.
