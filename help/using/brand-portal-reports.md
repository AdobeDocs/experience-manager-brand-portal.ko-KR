...
1. 자산 보고서 페이지에서 **[!UICONTROL 사용량]** 보고서 및 기타 생성된 보고서에 액세스합니다.
   ...
   >[!NOTE]
   >
   >사용량 보고서는 Brand Portal에서 생성된 기본 보고서입니다. 만들거나 삭제할 수 없습니다. 그러나 다운로드, 만료, 게시, `Link Share` 및 사용자 로그인 보고서를 만들고, 다운로드하고, 삭제할 수 있습니다.
...
또한 이 보고서에는 이러한 각 정보 지표에 대해 허용되는 능력이 표시됩니다.
   ...
   **[!UICONTROL Publish]** 보고서는 지정된 기간에 Experience Manager Assets에서 Brand Portal으로 게시된 모든 자산에 대한 정보를 나열하고 제공합니다.
...
1. 보고서 세부 사항을 구성합니다. **[!UICONTROL 다운로드]**, **[!UICONTROL 만료]** 및 **[!UICONTROL 게시]** 보고서에 대한 제목, 설명, 폴더 구조(보고서를 실행하고 통계를 생성해야 함) 및 날짜 범위를 지정하십시오.
...
1. 다운로드, 만료 및 게시 보고서의 열을 구성하려면 **[!UICONTROL 다음]**&#x200B;을 클릭합니다.
1. 필요에 따라 적절한 확인란을 선택하거나 선택 취소합니다. 예를 들어 **[!UICONTROL 다운로드]** 보고서에서 에셋을 다운로드한 사용자의 이름을 보려면 **[!UICONTROL 다운로드한 사람]**&#x200B;을 선택합니다. 다음 이미지는 다운로드 보고서에서 기본 열을 선택하는 방법을 보여줍니다.
   ...
   다운로드, 게시 또는 만료 보고서에 사용자 지정 열을 추가하려면 다음을 수행합니다.
