...
1. 자산 보고서 페이지에서 **[!UICONTROL 사용]** 보고서 및 기타 생성된 보고서에 액세스합니다.
   ...
   >[!NOTE]
   >
   >사용 보고서는 기본적으로 브랜드 포털에서 제공됩니다. 만들거나 삭제할 수 없습니다. 그러나 다운로드, 만료, 게시, 링크 공유 및 사용자 로그인 보고서를 만들고, 다운로드하고, 삭제할 수 있습니다.

   보고서를 보려면 보고서 링크를 탭/클릭합니다. 또는 보고서를 선택하고 도구 모음에서 보기 아이콘을 탭/클릭합니다.

   **[!UICONTROL 사용]** 보고서는 현재 브랜드 포털 사용자 수, 모든 자산이 차지하는 저장소 공간 및 브랜드 포털의 총 자산 수에 대한 정보를 표시합니다. 이 보고서에는 이러한 각 정보 지표에 대해 허용되는 용량도 표시됩니다.
