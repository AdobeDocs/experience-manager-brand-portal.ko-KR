...
>[!NOTE]
>
>동적 비디오는 Scene7Connect 런타임 모드에서 실행 중인 AEM 작성자로 구성된 브랜드 포털 **[!UICONTROL 테넌트에서]** 지원되지 않습니다.
...
2. 관리 도구 패널에서 비디오 **[!UICONTROL 타일을 선택합니다]** .<br />
...
2. 관리 도구 패널에서 Dynamic Media **[!UICONTROL 구성 타일을]** 선택합니다.<br />
