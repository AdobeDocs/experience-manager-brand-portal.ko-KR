...
Microsoft Edge는 EPM(Enhanced Protected Mode)에서 실행되므로 Aspera Connect 서버와의 통신이 불가능하고 동일한 개인 네트워크나 신뢰할 수 있는 사이트와의 통신이 불가능합니다. 따라서 서버와의 연결이 설정될 때마다 팝업이 표시됩니다.
...
1. 를 방문하여 포트가 차단되지 않았는지 확인하십시오 [https://test-connect.asperasoft.com](https://test-connect.asperasoft.com/) 사용자 시스템에서
...
1. Aspera 데모 서버에서 다운로드 작동 여부를 확인하려면 [https://demo.asperasoft.com/aspera/user](https://demo.asperasoft.com/aspera/user).\
