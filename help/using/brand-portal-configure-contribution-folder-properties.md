...
1. 로컬 컴퓨터에서 탐색하고 **자산 요구 사항 문서**&#x200B;를 업로드하려면 **[!UICONTROL 개요 업로드]**&#x200B;를 클릭합니다.
...
>[!NOTE]
>
>현재, 그룹을 기여도 폴더에 할당할 수 없습니다.
>
>검색 결과는 AEM Assets에 구성된 브랜드 포털 사용자 목록을 기반으로 합니다. 업데이트된 브랜드 포털 사용자 목록이 있는지 확인하십시오. [브랜드 포털 사용자 목록 업로드](brand-portal-configure-asset-sourcing.md)를 참조하십시오.
