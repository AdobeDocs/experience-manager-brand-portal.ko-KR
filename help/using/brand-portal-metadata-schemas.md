...
— [!UICONTROL `./jcr:created`]:자산의 노드에 jcr 속성을 표시합니다. 보기 속성에 이러한 속성을 구성하는 경우 해당 속성이 보호되므로 편집 비활성화 상태로 표시하는 것이 좋습니다. 그렇지 않으면 자산의 속성을 저장할 때 "자산을 수정하지 못했습니다"라는 오류가 발생합니다.
