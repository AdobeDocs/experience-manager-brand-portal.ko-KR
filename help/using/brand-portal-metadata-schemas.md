...
## {#edit-a-metadata-schema-form} 메타데이터 스키마 편집
...
### 빌드 양식 탭의 구성 요소 {#components-in-the-build-form-tab}
...
#### 스키마 양식 {#add-or-delete-a-tab-in-the-schema-form}에서 탭을 추가하거나 삭제합니다
...
#### 다양한 MIME 유형에 대해 기존 스키마 템플릿 사용 {#using-an-existing-schema-template-for-various-mime-types}
