...
description: 브랜드 포털에서 다양한 보기 옵션 및 UI 요소를 사용하여 자산을 검색하고 에셋 계층 구조를 트래버스하며 에셋을 검색할 수 있습니다.
seo-description: 브랜드 포털에서 다양한 보기 옵션 및 UI 요소를 사용하여 자산을 검색하고 에셋 계층 구조를 트래버스하며 에셋을 검색할 수 있습니다.
...
목록 보기에는 현재 수준의 각 리소스에 대한 정보가 표시됩니다. 목록 보기에는 다음 세부 정보가 표시됩니다.
...
열 보기를 사용하여 일련의 계단식 열을 통해 컨텐츠 트리를 탐색합니다. 이 보기는 자산 계층 구조를 시각화하고 트래버스하는 데 도움이 됩니다.

첫 번째 (가장 왼쪽) 열의 리소스를 선택하면 오른쪽의 두 번째 열에 하위 리소스가 표시됩니다. 두 번째 열의 리소스를 선택하면 오른쪽 세 번째 열에 하위 리소스가 표시됩니다.

리소스 이름 또는 리소스 이름 오른쪽에 있는 V 자형을 탭하거나 클릭하여 트리에서 위아래로 탐색할 수 있습니다.

* 탭하거나 클릭하면 리소스 이름 및 V 자형이 강조 표시됩니다.
* 썸네일을 탭하거나 클릭하면 리소스가 선택됩니다.
* 선택하면, 확인 표시가 썸네일에 오버레이되고 리소스 이름이 강조 표시됩니다.
* 선택한 리소스의 세부 사항이 마지막 열에 표시됩니다.

열 보기에서 자산을 선택하면 최종 열에 자산의 시각적 표현이 다음 세부 사항과 함께 표시됩니다.
...
자산 세부 사항 페이지에서 자산을 보거나, 자산을 다운로드하거나, 자산을 공유하거나, 컬렉션으로 이동하거나, 해당 속성 페이지를 볼 수 있습니다. 또한 동일한 폴더의 다른 자산의 세부 사항 페이지를 연속으로 탐색할 수도 있습니다.
...
자산 세부 사항 페이지에서 자산의 사용 가능한 모든 표현물을 보고 표현물을 선택하여 미리 볼 수 있습니다.
