...
브랜드 포털 사용자는 [자산 요구 사항](brand-portal-download-asset-requirements.md)을 다운로드하여 기여의 필요성을 파악할 수 있습니다.
...
>
>모든 브랜드 포털 테넌트의 최대 업로드 제한은 모든 기여도 폴더에 누적 적용되는 **10** GB입니다.
...
>
>브랜드 포털 테넌트의 업로드 제한을 **10** GB 이상으로 연장할 필요가 있는 경우, 요구 사항을 지정한 Adobe 지원 센터에 문의하십시오.
...
1. 기여도 폴더를 선택하고 을 클릭하여 엽니다. 기여도 폴더에는 두 개의 하위 폴더 **[!UICONTROL SHARED]** 및 **[!UICONTROL NEW]**&#x200B;가 있습니다.

1. **[!UICONTROL NEW]** 폴더를 클릭합니다.

   ![](assets/upload-new-assets1.png)

1. **[!UICONTROL 만들기]** > **[!UICONTROL 파일]**&#x200B;을 클릭하여 여러 자산이 들어 있는 개별 파일 또는 폴더(.zip)를 업로드합니다.
...
모든 자산이나 폴더를 새 폴더(NEW 폴더)에 업로드한 후 기여도 폴더를 AEM Assets에 게시합니다. 참조: [AEM Assets에 기여도 폴더 게시](brand-portal-publish-contribution-folder-to-aem-assets.md).
