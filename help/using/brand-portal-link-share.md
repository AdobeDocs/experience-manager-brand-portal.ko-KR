...
description: Adobe Experience Manager Assets Brand Portal 관리자는 파트너 및 공급업체 등 승인된 내부 사용자 및 외부 엔티티와 여러 자산의 링크를 공유할 수 있습니다. 편집자는 공유된 자산만 보고 공유할 수 있습니다.
...
1. 공유할 자산 또는 폴더를 선택하거나 **[!UICONTROL 컬렉션]** 보기 를 클릭하여 생성한 컬렉션을 공유하십시오.
...
1. 맨 위에 있는 도구 모음에서 **[!UICONTROL 링크 공유]** 아이콘.
   ...
   * 를 활성화합니다 **[!UICONTROL 원본 파일 다운로드 허용]** 수신자가 원본 변환을 다운로드할 수 있도록 하는 확인란을 선택합니다.
   ...
   링크를 통해 공유된 자산은 **[!UICONTROL 만료]** 필드. Brand Portal에서 사용자 역할에 따라 만료된 자산의 동작 및 허용 가능한 활동의 변경 사항에 대한 자세한 내용은 [자산의 디지털 권한 관리](../using/manage-digital-rights-of-assets.md#asset-expiration).

   >[!NOTE]
   >
   >링크의 기본 만료 시간은 7일입니다. 링크는 **[!UICONTROL 링크 공유]** 대화 상자에서 링크를 별도로 복사하고 공유하지 마십시오.
...
1. **[!UICONTROL 공유]**&#x200B;를 클릭합니다. 링크가 사용자와 공유되는지 확인하는 메시지가 나타납니다. 사용자는 공유 링크가 포함된 이메일을 받게 됩니다.
   ...
   >[!NOTE]
   >
   >관리자는 로고, 설명 및 바닥글을 사용자 지정하는 것을 포함하여 이메일 메시지를 사용자 지정할 수 있습니다 [브랜딩](../using/brand-portal-branding.md) 기능.
...
1. 자산 또는 폴더를 클릭한 다음 **[!UICONTROL 다운로드]** 아이콘 을 클릭하여 제품에서 사용할 수 있습니다.

   ![](assets/download-share-link.png)

   >[!NOTE]
   >
   >현재 파일 형식에 따라 특정 자산에 대해서만 미리 보기 및 축소판을 생성할 수 있습니다. 지원되는 파일 형식에 대한 자세한 내용은 [자산 형식에 대한 미리 보기 및 축소판 지원](#preview-thumbnail-support).

1. 다음 **[!UICONTROL 다운로드]** 대화 상자가 나타납니다.

   ![다운로드 대화 상자](assets/download-dialog-box-new.png)

1. 기본적으로 **[!UICONTROL 빠른 다운로드]** 이 설정은에서 활성화됩니다. **[!UICONTROL 다운로드 설정]**. 따라서 IBM Aspera Connect를 사용하여 계속 다운로드하도록 확인 상자가 나타납니다.

   계속 사용하려면 **[!UICONTROL 빠른 다운로드]**&#x200B;를 클릭합니다. **[!UICONTROL 허용]**.

   선택한 모든 표현물은 각 자산에 대한 별도의 폴더를 포함하는 zip 폴더에서 다운로드됩니다.

   >[!NOTE]
   >
   >공유 링크에서 자산을 다운로드하는 동안 각 자산에 대해 별도의 폴더가 만들어집니다.
   >
   >폴더, 컬렉션 또는 20개 이상의 자산을 다운로드하도록 선택한 경우, **[!UICONTROL 다운로드]** 대화 상자를 건너뛰고 다이내믹 표현물을 제외한 사용자가 액세스할 수 있는 모든 자산 표현물은 각 자산에 대한 별도의 폴더가 포함된 zip 폴더에서 다운로드됩니다.

   >[!NOTE]
   >
   >링크로 자산을 공유한 사용자가 아닌 경우 원래 표현물은 공유 링크를 사용하여 다운로드되지 않습니다 [관리자가 원래 표현물에 대한 액세스 권한을 갖도록 승인됨](../using/brand-portal-adding-users.md#manage-group-roles-and-privileges).


>[!NOTE]
>
>Brand Portal에서는 링크 공유를 사용하여 5GB보다 큰 폴더 또는 자산의 다운로드를 제한합니다.
...
1. 목록에서 링크 공유를 취소하려면 링크를 선택하고 **[!UICONTROL 공유 안 함]** 아이콘 을 클릭하여 제품에서 사용할 수 있습니다.
...
1. 경고 메시지 상자에서 **[!UICONTROL 계속]** 공유 해제를 확인합니다. 링크의 항목이 공유 링크 목록에서 제거됩니다.
